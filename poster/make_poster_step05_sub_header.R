...
title_cm <- qplot(1:9, 1:9, geom = "blank") +
  annotate("text", x = 5, y = 6.75, label = "CrimeMap (Shiny Web Application)", size = 22, colour = col_text) +
...
title_rcm <- qplot(1:9, 1:9, geom = "blank") +
  annotate("text", x = 5, y = 6.75, label = "rCrimemap (R Package on GitHub)", size = 22, colour = col_text) +
